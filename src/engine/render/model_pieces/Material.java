...
public class Material {
	...
	public String toString() {
		String ret = "";
		ret += "			ambientReflect: (" + ambientReflect.x + ","
			+ ambientReflect.y + "," + ambientReflect.z + ")\n";
		ret += "			diffuseReflect: (" + diffuseReflect.x + ","
			+ diffuseReflect.y + "," + diffuseReflect.z + ")\n";
		ret += "			specularReflect: (" + specularReflect.x + ","
			+ specularReflect.y + "," + specularReflect.z + ")\n";
		ret += "			emission: (" + emission.x + "," + emission.y + ","
			+ emission.z + ")\n";
