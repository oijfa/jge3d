...
public class Obj_Parser extends Parser{
	...
	private ArrayList<Vector3f> vertices = new ArrayList<Vector3f>(); // Vertex Coordinates
	private ArrayList<Vector3f> vertexNormals = new ArrayList<Vector3f>(); // Vertex Coordinates Normals
	//private ArrayList<Vector3f> vertexTextures = new ArrayList<Vector3f>(); // Vertex Coordinates Textures
	...
	private Face readFace(String string) throws Exception {
		...
		for( int i = 1; i < tokens.length; i++){
			...
			if(verts.length == 3){
				...
				System.out.println("Wierd OBJ file.  Uses alternative face format");
				throw new Exception();
			}
		}
		faceCount++;
