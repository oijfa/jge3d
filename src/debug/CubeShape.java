...
public class CubeShape {
	...
	public static void drawTestCube(float half_extent) {
        ...
        GL11.glTexCoord2f(0.0f, 0.0f); GL11.glVertex3f(-half_extent, -half_extent,  half_extent);   // Bottom Left Of The Texture and Quad
        GL11.glTexCoord2f(half_extent, 0.0f); GL11.glVertex3f( half_extent, -half_extent,  half_extent);   // Bottom Right Of The Texture and Quad
        GL11.glTexCoord2f(half_extent, half_extent); GL11.glVertex3f( half_extent,  half_extent,  half_extent);   // Top Right Of The Texture and Quad
        GL11.glTexCoord2f(0.0f, half_extent); GL11.glVertex3f(-half_extent,  half_extent,  half_extent);   // Top Left Of The Texture and Quad
